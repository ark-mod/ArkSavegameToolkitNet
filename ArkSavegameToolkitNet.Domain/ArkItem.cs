...
namespace ArkSavegameToolkitNet.Domain
{
    public class ArkItem : ArkGameDataContainerBase
    {
        ...
        public ArkItem(GameObject item, ArkSaveData saveState) : this()
        {
            _item = item;
            ...
            var itemId = item.GetProperty<PropertyListStructProperty>(_itemId);
            ...
            OwnerInventoryId = item.GetProperty<ObjectReferenceIdProperty>(_ownerInventory)?.id;
            //OwnerContainerId
            ...
            CreationTime = item.GetPropertyValue<double?>(_creationTime);
            {
                ...
                {
                    var statValue = item.GetPropertyValue<ushort?>(_itemStatValues[i]);
            ...
            EggDinoAncestors = ArkTamedCreatureAncestor.FromPropertyValue(item.GetProperty<StructArrayProperty>(_eggDinoAncestors));
            EggDinoAncestorsMale = ArkTamedCreatureAncestor.FromPropertyValue(item.GetProperty<StructArrayProperty>(_eggDinoAncestorsMale));

            {
                ...
                {
                    var color = item.GetPropertyValue<byte?>(_eggColorSetIndices[i]);
            ...
            }
            {
                ...
                {
                    var basestat = item.GetPropertyValue<byte?>(_eggNumberOfLevelUpPointsApplied[i]);
            ...
            var dropLocation = item.GetProperty<VectorStructProperty>(_originalItemDropLocation);
